...
// Shim for targets that don't have the shared HeartIDColors in target membership.
// If you later include the canonical HeartIDColors.swift in this target, remove this file to avoid redeclarations.
...
// Hex color initializer used by HeartIDColors
extension Color {
    init(hex: String) {
