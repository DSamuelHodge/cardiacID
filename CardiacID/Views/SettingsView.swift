...
struct SettingsView: View {
    ...
    @State private var showingLockoutSettings = false
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 20) {
                ...
                settingsSection(title: "Security") {
                    ...
                    .onChange(of: continuousAuth) { _, newValue in
                        if newValue {
                ...
                settingsSection(title: "Login Security") {
                    Button(action: {
                        showingLockoutSettings = true
                    }) {
                        settingRow(
                            title: "Login Attempt Lockout",
                            description: "Configure progressive lockout periods",
                            icon: "lock.rotation"
                        )
                    }
                    ...
                    if authViewModel.loginAttemptTracker.isLockedOut {
                        ...
                        HStack {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("Next failed attempt will trigger lockout")
                                    .font(.caption)
                                    .foregroundColor(colors.text.opacity(0.7))
                            }
                            Spacer()
                ...
                settingsSection(title: "Sensitivity") {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .padding(.top, 5)
                        .onChange(of: selectedSensitivity) { _, newValue in
        ...
        .sheet(isPresented: $showingLockoutSettings) {
            LockoutSettingsView()
