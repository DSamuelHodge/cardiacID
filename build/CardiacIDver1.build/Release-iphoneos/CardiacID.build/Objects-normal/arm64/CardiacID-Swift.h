...
#ifndef CARDIACID_SWIFT_H
#define CARDIACID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CardiacID",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9CardiacID24BluetoothDoorLockService")
@interface BluetoothDoorLockService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CBPeripheralManager;
@interface BluetoothDoorLockService (SWIFT_EXTENSION(CardiacID)) <CBPeripheralManagerDelegate>
...
@class NSString;
@class NSNumber;
@interface BluetoothDoorLockService (SWIFT_EXTENSION(CardiacID)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC9CardiacID23DeviceManagementService")
...
SWIFT_CLASS_NAMED("HeartReading")
@interface HeartReading : NSManagedObject
...
@interface Item (SWIFT_EXTENSION(CardiacID))
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@end

/// Service for NFC-based authentication and data exchange
SWIFT_CLASS("_TtC9CardiacID10NFCService")
...
@interface NFCService (SWIFT_EXTENSION(CardiacID)) <NFCNDEFReaderSessionDelegate>
...
SWIFT_CLASS("_TtC9CardiacID28TechnologyIntegrationService")
@interface TechnologyIntegrationService : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC9CardiacID24WatchConnectivityService")
...
@class WCSession;
@interface WatchConnectivityService (SWIFT_EXTENSION(CardiacID)) <WCSessionDelegate>
