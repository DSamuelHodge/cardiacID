...
#ifndef CARDIACID_WATCH_APP_SWIFT_H
#define CARDIACID_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CardiacID_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19CardiacID_Watch_App21BackgroundTaskService")
@interface BackgroundTaskService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// Service for managing Bluetooth communication (NFC not available on watchOS)
SWIFT_CLASS("_TtC19CardiacID_Watch_App19BluetoothNFCService")
@interface BluetoothNFCService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@class NSString;
@class NSNumber;
@interface BluetoothNFCService (SWIFT_EXTENSION(CardiacID_Watch_App)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC19CardiacID_Watch_App16HealthKitService")
@interface HealthKitService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// Service for handling communication between watchOS and iOS apps
SWIFT_CLASS("_TtC19CardiacID_Watch_App24WatchConnectivityService")
@interface WatchConnectivityService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@interface WatchConnectivityService (SWIFT_EXTENSION(CardiacID_Watch_App)) <WCSessionDelegate>
