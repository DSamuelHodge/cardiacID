...
struct SettingsView: View {
                        ...
                        if authenticationService.isUserEnrolled {
                            SettingsSection(title: "User Management") {
                                VStack(spacing: 12) {
                                    ...
                                    Text("This will delete the current user and reset the device to factory state")
                                        .font(.caption2)
                                        .foregroundColor(.secondary)
                                        .multilineTextAlignment(.center)
                                }
    ...
    private func clearAllData() {
        // Clear all data from authentication service
        authenticationService.clearAllData()
        
        // Clear all data from data manager
